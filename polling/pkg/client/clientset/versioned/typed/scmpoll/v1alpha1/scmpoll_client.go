...
import (
	...
	"github.com/tektoncd/experimental/polling/pkg/client/clientset/versioned/scheme"
...
func (c *TektonV1alpha1Client) SCMPolls(namespace string) SCMPollInterface {
	return newSCMPolls(c, namespace)
}

func (c *TektonV1alpha1Client) SCMPollStates(namespace string) SCMPollStateInterface {
	return newSCMPollStates(c, namespace)
}
