...
func (c *TektonV1alpha1Client) Polls(namespace string) PollInterface {
	return newPolls(c, namespace)
}

func (c *TektonV1alpha1Client) PollRuns(namespace string) PollRunInterface {
	return newPollRuns(c, namespace)
}
