...
import (
	...
	poll "github.com/tektoncd/experimental/polling/pkg/client/injection/informers/poll/v1alpha1/poll"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "poll-controller"
	defaultFinalizerName       = "polls.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	pollInformer := poll.Get(ctx)

	lister := pollInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.Poll"),
	)
