...
import (
	...
	pollrun "github.com/tektoncd/experimental/polling/pkg/client/injection/informers/poll/v1alpha1/pollrun"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "pollrun-controller"
	defaultFinalizerName       = "pollruns.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	pollrunInformer := pollrun.Get(ctx)

	lister := pollrunInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.PollRun"),
	)
