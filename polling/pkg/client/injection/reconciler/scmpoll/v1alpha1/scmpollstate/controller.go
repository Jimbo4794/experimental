...
import (
	...
	versionedscheme "github.com/tektoncd/experimental/polling/pkg/client/clientset/versioned/scheme"
	client "github.com/tektoncd/experimental/polling/pkg/client/injection/client"
	scmpollstate "github.com/tektoncd/experimental/polling/pkg/client/injection/informers/scmpoll/v1alpha1/scmpollstate"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "scmpollstate-controller"
	defaultFinalizerName       = "scmpollstates.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	scmpollstateInformer := scmpollstate.Get(ctx)

	lister := scmpollstateInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.SCMPollState"),
	)
