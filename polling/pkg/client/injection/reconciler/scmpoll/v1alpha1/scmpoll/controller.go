...
import (
	...
	scmpoll "github.com/tektoncd/experimental/polling/pkg/client/injection/informers/scmpoll/v1alpha1/scmpoll"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "scmpoll-controller"
	defaultFinalizerName       = "scmpolls.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	scmpollInformer := scmpoll.Get(ctx)

	lister := scmpollInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.SCMPoll"),
	)
