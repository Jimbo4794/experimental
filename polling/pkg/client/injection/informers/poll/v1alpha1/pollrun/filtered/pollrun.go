...
func Get(ctx context.Context, selector string) v1alpha1.PollRunInformer {
	untyped := ctx.Value(Key{Selector: selector})
	if untyped == nil {
		logging.FromContext(ctx).Panicf(
			"Unable to fetch github.com/tektoncd/experimental/polling/pkg/client/informers/externalversions/poll/v1alpha1.PollRunInformer with selector %s from context.", selector)
	}
