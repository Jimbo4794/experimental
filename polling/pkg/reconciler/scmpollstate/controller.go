...
import (
	...
	scmpollstatereconciler "github.com/tektoncd/experimental/polling/pkg/client/injection/reconciler/scmpoll/v1alpha1/scmpollstate"
...
func NewController(namespace string) func(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
	return func(ctx context.Context, cmw configmap.Watcher) *controller.Impl {
		...
		impl := scmpollstatereconciler.NewImpl(ctx, c, func(impl *controller.Impl) controller.Options {
